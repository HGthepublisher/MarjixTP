...
namespace marjtp.Variables
{
    ...
    public class Variables
    {
        ...
        public static void SetT(int i)
        {
            ...
            {
                new ByteBeat { freq = 11025, customByte = (byte)((t & t * 5 | t >> 6 | ((t & 0xFFFF) > 0x8000 ? (-6 * t) / 7 : ((t & 0x1FFFF) > 0x10000 ? -9 * t & 100 : (-9 * (t & 100))) / 11)) * 10) },
                new ByteBeat { freq = 8000, customByte = (byte)(t * (((t & 4096) != 0 ? t % 65536 < 59392 ? 7 : t & 7 : 16) + (1 & t >> 14)) >> (3 & -t >> ((t & 2048) != 0 ? 2 : 10))) },
                new ByteBeat { freq = 11025, customByte = (byte)(t / 8 >> (t >> 9) * t / ((t >> 14 & 3) + 4)) },
                ...
                new ByteBeat { freq = 11025, customByte = (byte)((((t >> 5 | t >> 4 | (t % 42 * (t >> 4) | 357052691 - (t >> 4)) / ((t >> 16) | 1) ^ (t | t >> 4)) & 255) + ((t % 25 - (t >> 2 | ((t & 16384) != 0 ? 64 / 3 : 16) * t | t % 227) - t >> 3 | (t >> 5 & 1663 * (t << 5) | (t >> 3) % 1544) / ((t % 17 | t % 2048) | 1)) & 255) + 100 * ((t << 2 | t >> 5 | t ^ 63) & (t << 10 | t >> 11)) % 256) / 3) },
                ...
                new ByteBeat { freq = 32000, customByte = (byte)(((t >> ((t >> 13) & 31)) & 128) + (((t & (t >> 12)) * t >> 12)) + (int)(300000.0 / (t % 16384 + 1))) },
